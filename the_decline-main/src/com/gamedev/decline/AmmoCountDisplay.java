...
public class AmmoCountDisplay 
{
   ...
   * 
   * @param newHero - the hero object whose ammo count is being
   *    displayed
   */
   ...
   * 
   * @param batch - the sprite batch that draws the text object
   */
  public void draw(SpriteBatch batch)
  {  
	font.draw(batch,"Ammo Left: "+new Integer(hero.getAmmo()).toString(), 
			xPostion, yPosition);
  }
}
